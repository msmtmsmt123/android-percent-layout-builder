...
public class ColorPanel extends JComponent {
	...
	private static final long serialVersionUID = 422682930945112856L;
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = 0; i < size; i++) {
			...
			Rectangle2D colorRect = new Rectangle2D.Double(rect.getX() + 2,
					rect.getY() + 2, rw - 4, rh - 4);
			g2d.fill(colorRect);
			g2d.setColor(borderColor);
			g2d.draw(colorRect);
		}
	...
	public void setSelectedColor(Color selectedColor) {
		if (this.selectedColor != selectedColor) {
			...
			this.firePropertyChange(ColorPicker.SELECTEDCOLORCHANGE, old,
					selectedColor);
		}
	}
